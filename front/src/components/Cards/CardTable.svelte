<script>
  ...
  const bootstrap = "/static/img/bootstrap.jpg";
  const angular = "/static/img/angular.jpg";
  const sketch = "/static/img/sketch.jpg";
  const react = "/static/img/react.jpg";
  const vue = "/static/img/react.jpg";

  const team1 = "/static/img/team-1-800x800.jpg";
  const team2 = "/static/img/team-2-800x800.jpg";
  const team3 = "/static/img/team-3-800x800.jpg";
  const team4 = "/static/img/team-4-470x470.png";
