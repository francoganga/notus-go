<script>
  ...
  const patternVue = "/static/img/pattern_svelte.png";
  const componentBtn = "/static/img/component-btn.png";
  const componentProfileCard = "/static/img/component-profile-card.png";
  const componentInfoCard = "/static/img/component-info-card.png";
  const componentInfo2 = "/static/img/component-info-2.png";
  const componentMenu = "/static/img/component-menu.png";
  const componentBtnPink = "/static/img/component-btn-pink.png";
  const documentation = "/static/img/documentation.png";
  const login = "/static/img/login.jpg";
  const profile = "/static/img/profile.jpg";
  const landing = "/static/img/landing.jpg";
</script>
